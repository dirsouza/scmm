...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vw_produtocomercio` (`idProdutoComercio` INT, `idproduto` INT, `'desProduto'` INT, `desmarca` INT, `idcomercio` INT, `'desComercio'` INT, `desPreco` INT, `'desEndereco'` INT);
